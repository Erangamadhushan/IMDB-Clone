...
export const HeroSection = () => {
  return (
    <section className="hero-section w-full min-h-[90vh] bg-gray-800 flex flex-col justify-center items-start px-4 " style={{ backgroundImage: 'url(/theatre-room2.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
